...
import com.scoutlabour.activities.AddNewAddressActivity;
import com.scoutlabour.activities.AllServicesActivity;
import com.scoutlabour.activities.HomeActivity;
...
public class CleaningFragment extends Fragment {
    ...
    RecyclerView recyclerViewCleaning;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View convertView= inflater.inflate(R.layout.fragment_cleaning, container, false);
        recyclerViewCleaning = (RecyclerView) convertView.findViewById(R.id.recyclerViewCleaning);
        recyclerViewCleaning.setHasFixedSize(true);
        recyclerViewCleaning.setItemAnimator(new DefaultItemAnimator());
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getActivity(), 1);
        recyclerViewCleaning.setLayoutManager(layoutManager);
        recyclerViewCleaning.setItemAnimator(new DefaultItemAnimator());
        ...
        {
            if(subCategoryDetailModels.get(i).category_id.equalsIgnoreCase("1")) {
        ...
        recyclerViewCleaning.setAdapter(customAdapter); // set the Adapter to RecyclerView
        // set the emptyView in recycleview
        customAdapter.registerAdapterDataObserver(new RVEmptyObserver(recyclerViewCleaning, emptyView));
