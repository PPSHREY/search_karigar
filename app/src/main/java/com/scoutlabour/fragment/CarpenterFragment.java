...
public class CarpenterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        View convertView= inflater.inflate(R.layout.fragment_carpenter, container, false);
        recyclerViewCarpenter = (RecyclerView) convertView.findViewById(R.id.recyclerViewCarpenter);
        recyclerViewCarpenter.setHasFixedSize(true);
        recyclerViewCarpenter.setItemAnimator(new DefaultItemAnimator());
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getActivity(), 1);
        recyclerViewCarpenter.setLayoutManager(layoutManager);
        recyclerViewCarpenter.setItemAnimator(new DefaultItemAnimator());
        ...
        {
            if(subCategoryDetailModels.get(i).category_id.equalsIgnoreCase("2")) {
        ...
        recyclerViewCarpenter.setAdapter(customAdapter); // set the Adapter to RecyclerView
        // set the emptyView in recycleview
        customAdapter.registerAdapterDataObserver(new RVEmptyObserver(recyclerViewCarpenter, emptyView));
        return convertView;
    }
