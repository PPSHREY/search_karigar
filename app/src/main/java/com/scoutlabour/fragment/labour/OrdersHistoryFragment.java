...
//                registrationObject.put("user_id", "2");
            ...
            new PostServiceCall(AppConstants.ORDERS_LIST_KARIGAR_DONE, registrationObject) {
...
//                    progressDialog.dismiss();
    ...
    public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
        ...
        public CustomAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.requests_item_list_done, parent, false);
