 ...
 */
public class MasonryWorkFragment extends Fragment {

    RecyclerView recyclerViewMasonry_work;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View convertView= inflater.inflate(R.layout.fragment_masonry_work, container, false);
        recyclerViewMasonry_work = (RecyclerView) convertView.findViewById(R.id.recyclerViewMasonry_work);
        recyclerViewMasonry_work.setHasFixedSize(true);
        recyclerViewMasonry_work.setItemAnimator(new DefaultItemAnimator());
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getActivity(), 1);
        recyclerViewMasonry_work.setLayoutManager(layoutManager);
        recyclerViewMasonry_work.setItemAnimator(new DefaultItemAnimator());
        ...
        {
            if(subCategoryDetailModels.get(i).category_id.equalsIgnoreCase("3")) {
        ...
        recyclerViewMasonry_work.setAdapter(customAdapter); // set the Adapter to RecyclerView
        // set the emptyView in recycleview
        customAdapter.registerAdapterDataObserver(new RVEmptyObserver(recyclerViewMasonry_work, emptyView));
