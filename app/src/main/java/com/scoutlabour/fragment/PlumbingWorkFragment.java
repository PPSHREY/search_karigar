 ...
 */
public class PlumbingWorkFragment extends Fragment {

    RecyclerView recyclerViewPlumbingWork;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View convertView= inflater.inflate(R.layout.fragment_plumbing_work, container, false);
        recyclerViewPlumbingWork = (RecyclerView) convertView.findViewById(R.id.recyclerViewPlumbingWork);
        recyclerViewPlumbingWork.setHasFixedSize(true);
        recyclerViewPlumbingWork.setItemAnimator(new DefaultItemAnimator());
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getActivity(), 1);
        recyclerViewPlumbingWork.setLayoutManager(layoutManager);
        recyclerViewPlumbingWork.setItemAnimator(new DefaultItemAnimator());
        ...
        {
            if(subCategoryDetailModels.get(i).category_id.equalsIgnoreCase("5")) {
        ...
        recyclerViewPlumbingWork.setAdapter(customAdapter); // set the Adapter to RecyclerView
        // set the emptyView in recycleview
        customAdapter.registerAdapterDataObserver(new RVEmptyObserver(recyclerViewPlumbingWork, emptyView));
