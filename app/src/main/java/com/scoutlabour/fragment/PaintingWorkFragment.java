 ...
 */
public class PaintingWorkFragment extends Fragment {


    RecyclerView recyclerViewPaintingWork;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View convertView= inflater.inflate(R.layout.fragment_painting_work, container, false);
        recyclerViewPaintingWork = (RecyclerView) convertView.findViewById(R.id.recyclerViewPaintingWork);
        recyclerViewPaintingWork.setHasFixedSize(true);
        recyclerViewPaintingWork.setItemAnimator(new DefaultItemAnimator());
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getActivity(), 1);
        recyclerViewPaintingWork.setLayoutManager(layoutManager);
        recyclerViewPaintingWork.setItemAnimator(new DefaultItemAnimator());
        ...
        {
            if(subCategoryDetailModels.get(i).category_id.equalsIgnoreCase("4")) {
        ...
        recyclerViewPaintingWork.setAdapter(customAdapter); // set the Adapter to RecyclerView
        // set the emptyView in recycleview
        customAdapter.registerAdapterDataObserver(new RVEmptyObserver(recyclerViewPaintingWork, emptyView));
