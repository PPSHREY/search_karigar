...
public class AcServicesFragment extends Fragment {
    RecyclerView recyclerViewAcServices;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View convertView= inflater.inflate(R.layout.fragment_ac_services, container, false);
        recyclerViewAcServices = (RecyclerView) convertView.findViewById(R.id.recyclerViewAcServices);
        recyclerViewAcServices.setHasFixedSize(true);
        recyclerViewAcServices.setItemAnimator(new DefaultItemAnimator());
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getActivity(), 1);
        recyclerViewAcServices.setLayoutManager(layoutManager);
        recyclerViewAcServices.setItemAnimator(new DefaultItemAnimator());
        ...
        {
            if(subCategoryDetailModels.get(i).category_id.equalsIgnoreCase("7")) {
        ...
        recyclerViewAcServices.setAdapter(customAdapter); // set the Adapter to RecyclerView
        // set the emptyView in recycleview
        customAdapter.registerAdapterDataObserver(new RVEmptyObserver(recyclerViewAcServices, emptyView));
